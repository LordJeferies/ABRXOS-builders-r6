...
def _append_request_instructions(base:str,req:dict,case_id:str)->str:
    ...
    lines += ['','REGLAS DE SALIDA:','- Devuelve JSON válido listo para Geometra y un TXT humano equivalente.','- No inventes timestamps.','- Conserva IDs estables al actualizar fichas.']
